...
const cameraSwitcherEl = document.querySelector<HTMLSelectElement>('select[name="camera"]');
...
async function populateVideo(cameraId?: string) {
  ...
  constraints.video = cameraId ? { deviceId: { exact: cameraId },         height: { min: 576, ideal: 720, max: 1080 }, } : true;
